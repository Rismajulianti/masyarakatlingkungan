    ...
    <nav class="navbar" role="navigation" aria-label="main navigation">
        ...
        <div id="navbar" class="navbar-menu ">
            <div class="navbar-start">
                <a class="navbar-item text-decoration-none" href="{{route('home')}}">
                    Beranda
                </a>
                ...
                <div class="navbar-item has-dropdown is-hoverable ">
                    ...
                    <div class="navbar-dropdown">
                        <a class="navbar-item text-decoration-none" href="{{url('/laporkansekarang')}}">
                            Rumah Tangga
                        </a>
                        <a class="navbar-item text-decoration-none" href="{{url('/laporkansekarang')}}">
                            Pembuangan Limbah
                        ...
                        <hr class="navbar-divider text-decoration-none" href="{{url('/laporkansekarang')}}">
                        <a class="navbar-item">
                            Lainnya
                        </a>
                    </div>
